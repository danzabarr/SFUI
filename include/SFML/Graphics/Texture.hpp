...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool loadFromFile(const std::string& filename, const IntRect& calculated_area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool loadFromMemory(const void* data, std::size_t size, const IntRect& calculated_area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool loadFromStream(InputStream& stream, const IntRect& calculated_area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool loadFromImage(const Image& image, const IntRect& calculated_area = IntRect());
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Uint8* pixels);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Uint8* pixels, unsigned int width, unsigned int height, unsigned int x, unsigned int y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Texture& texture);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Texture& texture, unsigned int x, unsigned int y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Image& image);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Image& image, unsigned int x, unsigned int y);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Window& window);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void updateDisplay(const Window& window, unsigned int x, unsigned int y);
